...
- Fixed empty splash pools, repeated random entries, vanilla-source selection, custom-file handling, and animated click bounds.
- Removed the circular runtime linkage with Bounced.
